...
export default async function AboutPage() {
  ...
  return (
    <div style={{ background: "#fffaf0", color: "#1a1a1a", fontFamily: "var(--font-sans)", minHeight: "100vh" }}>
      ...
      {/* HEADER */}
      <section className="layout-two-col px-4 md:px-14 py-12 md:py-16 relative" style={{ borderBottom: "1px solid #1a1a1a" }}>
        <div>
          <div style={{ fontFamily: "var(--font-hand)", fontSize: 26, color: "#ee7c5a", marginBottom: 8 }}>✿ the story so far</div>
          <h1 style={{ fontFamily: "var(--font-display)", fontWeight: 400, fontSize: "clamp(3rem, 12vw, 6.25rem)", lineHeight: 0.92, letterSpacing: "-0.03em", margin: 0 }}>
        ...
        <div className="hidden md:flex absolute top-6 right-14 gap-2">
      ...
      {/* MAIN STORY */}
      <section className="layout-two-col-center px-4 md:px-14 py-12 md:py-16">
        <div style={{ transform: "rotate(-2deg)" }}>
          <div style={{ background: "#fff", padding: 14, paddingBottom: 44, border: "2px solid #1a1a1a", boxShadow: "8px 8px 0 rgba(0,0,0,.08)", position: "relative" }}>
            ...
            <div style={{ position: "absolute", bottom: 12, left: 0, right: 0, textAlign: "center", fontFamily: "var(--font-hand)", fontSize: 20, color: "#1a1a1a" }}>the kitchen-table studio, portland ✿</div>
          </div>
        </div>
        <div>
          <h2 style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: "clamp(2rem, 6vw, 3.5rem)", lineHeight: 0.95, letterSpacing: -1, margin: "0 0 24px" }}>
      ...
      {/* VALUES STRIP */}
      <section className="mx-4 md:mx-14 mb-10 md:mb-14 rounded-[32px] px-8 md:px-12 py-10 border-2 border-[#1a1a1a]" style={{ background: "#fdf3df" }}>
        <div style={{ fontFamily: "var(--font-hand)", fontSize: 26, color: "#ee7c5a", marginBottom: 8 }}>how it works ✿</div>
        <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.75rem, 5vw, 2.75rem)", letterSpacing: -1, margin: "0 0 32px" }}>Every piece, start to finish</h2>
        <div className="layout-values">
          {[
            ...
            <div key={n} className="flex flex-col gap-3">
              <div style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: "clamp(2rem, 6vw, 3rem)", color: "#ee7c5a", lineHeight: 1 }}>{n}</div>
              <h3 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.1rem, 3vw, 1.5rem)", margin: 0, letterSpacing: -0.4 }}>{title}</h3>
              <p style={{ fontSize: 14, lineHeight: 1.6, color: "#5a5236", margin: 0 }}>{desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* CUSTOM CTA */}
      <section className="layout-cta mx-4 md:mx-14 mb-16 rounded-[32px] px-8 md:px-12 py-10 border-2 border-[#1a1a1a] relative" style={{ background: "#3b5b85", color: "#fffaf0" }}>
        ...
        <div>
          <h2 style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: "clamp(2rem, 6vw, 3.5rem)", lineHeight: 0.95, letterSpacing: -1, margin: "0 0 18px" }}>Got your granddad&apos;s old jeans?</h2>
        ...
        <div style={{ transform: "rotate(2deg)" }}>
          <div style={{ background: "#fffaf0", padding: 14, paddingBottom: 38, border: "2px solid #1a1a1a", position: "relative" }}>
            ...
            <div style={{ position: "absolute", bottom: 10, left: 0, right: 0, textAlign: "center", fontFamily: "var(--font-hand)", fontSize: 18, color: "#1a1a1a" }}>rachel&apos;s granddad&apos;s wranglers ✿</div>
          </div>
        </div>
      </section>
